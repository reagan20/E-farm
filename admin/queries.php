...
if(isset($_POST['add_product'])){
    ...
    if(in_array($imgExt,$valid))
    {
        ...
        $stmt=$conn->query("INSERT INTO products(vendor_id,product_name,category,qty,price,description,image) VALUES('$vendor_id','$product_name','$category','$qty','$price','$description','$imgFile')");
        if($stmt){
