    ...
    <aside class="main-sidebar dark-bg">
        <section class="sidebar">
            <div class="user-panel black-bg">
                <div class="pull-left image"> <img src="assets/dist/img/img1.jpg" class="img-circle" alt="User Image"> </div>
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview"><a href="#"><i class="fa fa-dashboard"></i> <span>Dashboard</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
                    <ul class="treeview-menu">
                        <li><a href="../index-2.html"><i class="fa fa-angle-right"></i> Dashboard 1</a></li>
                ...
                <li class="treeview"> <a href="#"><i class="fa fa-bullseye"></i> <span>Apps</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="app/contacts.html"><i class="fa fa-angle-right"></i> Contacts</a></li>
                    </ul>
                </li>
                ...
                <li class="treeview active"> <a href="#"><i class="fa fa-table"></i> <span>Tables</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
                    <ul class="treeview-menu">
                        <li><a href="tables/basic.html"><i class="fa fa-angle-right"></i> Basic Tables</a></li>
                        <li class="active"><a href="tables/data.html"><i class="fa fa-angle-right"></i> Data Tables</a></li>
                    </ul>
                </li>
                ...
                <li class="treeview"> <a href="#"><i class="fa fa-files-o"></i> <span>Pages</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
                    <ul class="treeview-menu">
                        <li><a href="../index.php"><i class="fa fa-angle-right"></i> Login</a></li>
...
<script src="assets/plugins/tables/jquery.tablesort.js"></script>
<script src="assets/dist/datatables/jquery.dataTables.min.js"></script>
<script src="assets/dist/datatables/dataTables.bootstrap.js"></script>
