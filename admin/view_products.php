...
<?php require_once('include/leftsidebar.php');?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content container-fluid">
            ...
            <div class="row">
                <div class="col-md-3">
                    <a href="" data-toggle="modal" data-target="#add_product" class="btn btn-success"><i class="fa fa-plus"></i> AddProduct</a>
                </div>
            </div><br/>
            <div>
                <?php
                                                ...
                                                <div class="modal-body">
                                                    <form method="post" action="queries.php?id=<?php echo $q1['id'];?>" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="submit" name="update" class="btn btn-success" href=""><i class="fa fa-save"></i> Save</button>
