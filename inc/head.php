...
<?php
if(!isset($_SESSION['customer']) && (!isset($_SESSION['role_session'])))
{
                ...
                <div class="header-inner">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-6">
                            <div class="navbar-header align-center float-left-sm"> <a class="navbar-brand page-scroll" href="index"></a> </div>
                        </div>
                        <div class="col-md-4 col-sm-6 col-xs-6">
                ...
                <div id="menu" class="navbar-collapse collapse align-center">
                    <ul class="nav navbar-nav navbar-left">
                        ...
                        if(isset($_SESSION['customer'])==""){
                            ...
                            <li class="level" style="background-color:lightgreen "> <span class="opener plus"></span> <a href="Customer_Dashboard" class="page-scroll">Dashboard</a>
                                <div class="megamenu mobile-sub-menu">
                                    <div class="megamenu-inner-top">
                                        <ul class="sub-menu-level1">
                                            <li class="level2">
                                                <ul class="sub-menu-level2 ">
                                                    <li class="level3"><a href="Customer_Dashboard"><span><i class="fa fa-user"></i></span> Account</a></li>
...
<!--                                                    <li class="level3"><a href="pending_orders"><span><i class="fa fa-shopping-cart"></i></span>Pending Orders</a></li>-->
                                                    <li class="level3"><a href="logout"><span><i class="fa fa-signout"></i></span> Logout</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </div>
